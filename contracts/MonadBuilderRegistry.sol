...
/// @title MonadBuilderRegistry
/// @notice Platform-level contract for MonadBuilder+ — no-code dApp builder on Monad Testnet
/// @dev Deployed once to represent the MonadBuilder+ platform on-chain.
///      Each user dApp gets its own MonadDApp contract when they click "Deploy to Monad".
contract MonadBuilderRegistry {
